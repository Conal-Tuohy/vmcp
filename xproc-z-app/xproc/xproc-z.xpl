<p:declare-step 
	...
	<p:group>
		...
		<p:variable name="corpus-base-uri" select="/c:param-set/c:param[@name='corpus-base-uri']/@value">
			<p:pipe step="configuration" port="result"/>
		</p:variable>
		<p:variable name="solr-base-uri" select="/c:param-set/c:param[@name='solr-base-uri']/@value">
			<p:pipe step="configuration" port="result"/>
		</p:variable>
		<p:variable name="search-fields" select="/c:param-set/c:param[@name='search-fields']/@value">
			<p:pipe step="configuration" port="result"/>
		</p:variable>
	...
	<p:choose>
		...
		<p:when test="starts-with($relative-uri, 'text/') ">
			...
			<p:variable name="file-absolute-uri" select="concat($corpus-base-uri, $file-relative-uri)"/>
