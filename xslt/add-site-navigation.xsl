			...
			<header id="header">
				<nav id="main-nav">
					...
					<form id="quick-search" action="/search/" method="GET">
						<div>
							<input type="text" name="text" placeholder="Search letters"/>
							<button type="submit"><svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="search" xmlns="http://www.w3.org/2000/svg" 
								fill="currentColor" class="bi-search b-icon bi" data-v-274f1e68="">
								<g data-v-274f1e68="">
			...
			<nav class="internal">
				...
				<ul>
					<xsl:for-each select="$sub-menu/fn:string">
						<li><a class="dropdown-item" href="{.}"><xsl:if test=". = $current-uri">
			...
			<div id="rbgv-footer">
				...
				<div class="social-media">
					<a href="https://www.instagram.com/royalbotanicgardensvic/" target="_blank">
						<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="instagram" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-instagram m-media b-icon bi" style="font-size:150%;">
							<g>
					...
					<a href="https://www.facebook.com/BotanicGardensVictoria" target="_blank">
						<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="facebook" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-facebook m-media b-icon bi" style="font-size:150%;">
							<g>
					...
					<a href="https://twitter.com/RBG_Victoria" target="_blank">
						<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="twitter" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-twitter m-media b-icon bi" style="font-size:150%;">
							<g>
					...
					<a href="https://www.youtube.com/channel/UCSVV1rE_DbHr8MPzFu9g5WQ" target="_blank">
						<svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="youtube" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-youtube m-media b-icon bi" style="font-size:150%;">
							<g>
